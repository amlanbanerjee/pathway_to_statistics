...
attributes<-list(node=list(label="foo", fillcolor="lightgreen", fontsize="10"),
                 edge=list(color="red", fontsize="10"),graph=list(rankdir="LR"))
...
text(340,440,"(+ | D)",cex=.8)

text(340,230,"(+ | ND)",cex=.8)

#Write a table in the lower left of the probablites of A and B
text(80,50,paste("P(D):",a),cex=.9, col="darkgreen")
text(80,20,paste("P(ND):",notA),cex=.9, col="darkgreen")

text(160,50,paste("P(+):",round(b,digits=2)),cex=.9)
text(160,20,paste("P(-):",round(notB, 2)),cex=.9)

text(80,420,paste("P(D|+): ",round(aGivenb,digits=2)),cex=.9,col="blue")
